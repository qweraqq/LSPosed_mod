...
import com.google.android.lspmngr.BuildConfig;
import com.google.android.lspmngr.ConfigManager;
import com.google.android.lspmngr.R;
import com.google.android.lspmngr.databinding.DialogAboutBinding;
import com.google.android.lspmngr.databinding.FragmentHomeBinding;
import com.google.android.lspmngr.ui.dialog.BlurBehindDialogBuilder;
import com.google.android.lspmngr.ui.dialog.FlashDialogBuilder;
import com.google.android.lspmngr.ui.dialog.WelcomeDialog;
import com.google.android.lspmngr.util.NavUtil;
import com.google.android.lspmngr.util.UpdateUtil;
import com.google.android.lspmngr.util.chrome.LinkTransformationMethod;
...
public class HomeFragment extends BaseFragment implements MenuProvider {
    ...
    public void onPrepareMenu(Menu menu) {
        ...
        menu.findItem(R.id.menu_issue).setOnMenuItemClickListener(v -> {
            NavUtil.startURL(requireActivity(), "https://github.com/pumPCin/LSPosed_mod/issues/new/choose");
            return true;
        });
    }
    ...
    public static class AboutDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            binding.designAboutInfo.setText(HtmlCompat.fromHtml(getString(
                    ...
                    "<b><a href=\"https://github.com/pumPCin/LSPosed_mod\">GitHub</a></b>",
